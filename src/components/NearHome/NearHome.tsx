...
const exploreData: CityData[] = [
  { id: '1', city: 'Abuja', hotels: 324, Image: HomeAbuja },
  { id: '2', city: 'Oyo', hotels: 433, Image: HomeOyo },
  { id: '3', city: 'Lagos', hotels: 511, Image: HomeLagos },
  { id: '4', city: 'Abuja', hotels: 324, Image: HomeAbuja },
  { id: '5', city: 'Oyo', hotels: 433, Image: HomeOyo },
  { id: '6', city: 'Lagos', hotels: 511, Image: HomeLagos },
  { id: '7', city: 'Abuja', hotels: 324, Image: HomeAbuja },
  { id: '8', city: 'Oyo', hotels: 433, Image: HomeOyo },
  { id: '9', city: 'Lagos', hotels: 511, Image: HomeLagos },
]

const discountData = [
  { id: '1', text: '15% OFF on your first booking', Icon: HomeBooking },
  { id: '2', text: '25% OFF on your first booking', Icon: HomeBooking },
  { id: '3', text: '35% OFF on your first booking', Icon: HomeBooking },
  { id: '4', text: '45% OFF on your first booking', Icon: HomeBooking },
  { id: '5', text: '55% OFF on your first booking', Icon: HomeBooking },
  { id: '6', text: '65% OFF on your first booking', Icon: HomeBooking },
]
  ...
  useEffect(() => {
    if (isAutoPlay) {
      interval.current = setInterval(() => {
        offset.value = (offset.value + 1) % nearMeData.length
      }, 2000)
    } else {
